...
const OptionExitist = await lmsQuestionOptions.findOne({
  where: { qpQuestionId: result.blockId , qpSecondaryId: object.secondaryId, qpQuestNo:result.blockQuestNo,qpGameId:id,qpDeleteStatus:'NO' },
});
